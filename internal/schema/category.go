...
type GetCategoriesQuery struct {
	...
	OrderBy  []string `query:"order_by" validate:"omitempty,dive,oneof=name -name +name created_at -created_at +created_at updated_at -updated_at +updated_at" db:"order_by"`
}
